  ...
  return (
    <>
      ...
      <Dialog open={modalAberto} onOpenChange={setModalAberto}>
        <DialogContent className="sm:max-w-md z-[60] bg-white">
          <DialogHeader>
          ...
          <div className="space-y-6 py-4">
            <Input
              ...
              className="text-lg h-12 text-gray-900 border-gray-300 placeholder:text-gray-400 bg-white"
              autoFocus
              onKeyDown={(e) => {
            ...
            <Button
              ...
              disabled={!nome.trim()}
              className="w-full h-12 text-lg font-semibold bg-emerald-600 hover:bg-emerald-700 text-white disabled:opacity-50"
              size="lg"
            >
              Confirmar
            </Button>
