...
export type TipoGastoDespesa = 'empresarial' | 'pessoal';

export interface Despesa {
  id: string;
  data_despesa: string; // ISO date string
  tipo_despesa: TipoDespesa;
  categorias?: string[]; // Múltiplas categorias (substitui tipo_despesa no futuro)
  descricao: string;
  valor: number;
  ...
  tipo_gasto?: TipoGastoDespesa; // 'empresarial' (padrão) ou 'pessoal'
